...
internal extension API.Bus {
    ...
    struct NextBuses: Endpoint {
        typealias Response = Responses.BusPredictions
    ...
    struct StopsSearch: Endpoint {
        typealias Response = Responses.StopsSearchResponse
...
internal extension API.Rail {
    struct Lines: Endpoint {
        typealias Response = Responses.LinesResponse
    ...
    struct Entrances: Endpoint {
        typealias Response = Responses.StationEntrances
    ...
    struct Positions: OnlyJSONEndpoint {
        typealias Response = Responses.TrainPositions
    ...
    struct Routes: OnlyJSONEndpoint {
        typealias Response = Responses.StandardRoutes
    ...
    struct Circuits: OnlyJSONEndpoint {
        typealias Response = Responses.TrackCircuits
    ...
    struct StationToStation: Endpoint {
        typealias Response = Responses.StationToStationInfos
    ...
    struct ElevatorAndEscalatorIncidents: Endpoint {
        typealias Response = ElevatorAndEscalatorIncidents
    ...
    struct Incidents: Endpoint {
        typealias Response = Responses.RailIncidents
    ...
    struct NextTrains: Endpoint {
        typealias Response = Responses.RailPredictions
    ...
    struct Information: Endpoint {
        typealias Response = Responses.StationInformation
    ...
    struct ParkingInformation: Endpoint {
        typealias Response = Responses.StationsParking
    ...
    struct Path: Endpoint {
        typealias Response = Responses.PathBetweenStations
    ...
    struct Timings: Endpoint {
        typealias Response = Responses.StationTimings
    ...
    struct Stations: Endpoint {
        typealias Response = Responses.Stations
