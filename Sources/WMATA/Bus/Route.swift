...
public class Route: Fetcher, RequestBuilder {
    ...
    /// URLs of WMATA endpoints relating to Routes
    enum Urls: String {
        ...
        case schedule = "https://api.wmata.com/Bus.svc/json/jRouteSchedule"
    }
    ...
    /// Bus positions including latlong and direction. Omit latitude, longitude and radius to receive all bus positions along this Route.
    ///
