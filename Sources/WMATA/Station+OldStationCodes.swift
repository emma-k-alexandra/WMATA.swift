...
public extension Station {
    ...
    @available(*, deprecated, renamed: "galleryPlaceLower")
    static let F01 = Self.galleryPlaceLower
    
    @available(*, deprecated, renamed: "archives")
    static let F02 = Self.archives
    
    @available(*, deprecated, renamed: "lenfantPlazaUpper")
    static let F03 = Self.lenfantPlazaUpper
    
    @available(*, deprecated, renamed: "waterfront")
    static let F04 = Self.waterfront
    
    @available(*, deprecated, renamed: "navyYard")
    static let F05 = Self.navyYard
    
    @available(*, deprecated, renamed: "anacostia")
    static let F06 = Self.anacostia
    
    @available(*, deprecated, renamed: "congressHeights")
    static let F07 = Self.congressHeights
    
    @available(*, deprecated, renamed: "southernAvenue")
    static let F08 = Self.southernAvenue
    
    @available(*, deprecated, renamed: "naylorRoad")
    static let F09 = Self.naylorRoad
    
    @available(*, deprecated, renamed: "suitland")
    static let F10 = Self.suitland
    
    @available(*, deprecated, renamed: "branchAve")
    static let F11 = Self.branchAve
    
    @available(*, deprecated, renamed: "benningRoad")
    static let G01 = Self.benningRoad
    
    @available(*, deprecated, renamed: "capitolHeights")
    static let G02 = Self.capitolHeights
    
    @available(*, deprecated, renamed: "addisonRoad")
    static let G03 = Self.addisonRoad
    ...
    @available(*, deprecated, renamed: "franconia")
    static let J03 = Self.franconia
    
    @available(*, deprecated, renamed: "courtHouse")
    static let K01 = Self.courtHouse
    
    @available(*, deprecated, renamed: "clarendon")
    static let K02 = Self.clarendon
    
    @available(*, deprecated, renamed: "virginiaSquare")
    static let K03 = Self.virginiaSquare
    
    @available(*, deprecated, renamed: "ballston")
    static let K04 = Self.ballston
    
    @available(*, deprecated, renamed: "eastFallsChurch")
    static let K05 = Self.eastFallsChurch
    
    @available(*, deprecated, renamed: "westFallsChurch")
    static let K06 = Self.westFallsChurch
    
    @available(*, deprecated, renamed: "dunnLoring")
    static let K07 = Self.dunnLoring
    
    @available(*, deprecated, renamed: "vienna")
    static let K08 = Self.vienna
    ...
    @available(*, deprecated, renamed: "springHill")
    static let N04 = Self.springHill
    
    @available(*, deprecated, renamed: "wiehle")
    static let N06 = Self.wiehle
    
    @available(*, deprecated, renamed: "restonTownCenter")
    static let N07 = Self.restonTownCenter
    
    @available(*, deprecated, renamed: "herndon")
    static let N10 = Self.herndon
    
    @available(*, deprecated, renamed: "innovationCenter")
    static let N11 = Self.innovationCenter
    
    @available(*, deprecated, renamed: "dullesInternationalAirport")
    static let N12 = Self.dullesInternationalAirport
    
    @available(*, deprecated, renamed: "loudounGateway")
    static let N14 = Self.loudounGateway
    
    @available(*, deprecated, renamed: "ashburn")
    static let N15 = Self.ashburn
}
