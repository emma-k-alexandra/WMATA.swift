...
//    ///
//    /// - Parameters:
//    ///     - location: Radius at latitude and longitude to search at. Optional.
//    func searchStops(at location: RadiusAtCoordinates? = nil) {
//        request(
...
//    func searchStops(at location: RadiusAtCoordinates? = nil, completion: @escaping (_ result: Result<StopsSearchResponse, WMATAError>) -> Void) {
//        fetch(
//            endpoint: API.Bus.StopsSearch(
//                key: key,
//                location: location
...
//    func searchStopsPublisher(at location: RadiusAtCoordinates? = nil) -> AnyPublisher<StopsSearchResponse, WMATAError> {
//        publisher(
//            endpoint: API.Bus.StopsSearch(
//                key: key,
//                location: location
...
//    ///     - location: Radius at latitude and longitude to search at. Optional.
//    func positions(on route: Route? = nil, at location: RadiusAtCoordinates? = nil) {
//        (self as NeedsRoute).positions(on: route, at: location, key: key, session: session)
//    }
//
//    /// Bus positions including latlong and direction. Omit routeId, latitude, longitude and radius to receive all bus positions.
//    ///
...
//    func positions(on route: Route? = nil, at location: RadiusAtCoordinates? = nil, completion: @escaping (_ result: Result<BusPositions, WMATAError>) -> Void) {
//        (self as NeedsRoute).positions(on: route, at: location, key: key, session: session, completion: completion)
//    }
//
...
//    func positionsPublisher(on route: Route? = nil, at location: RadiusAtCoordinates? = nil) -> AnyPublisher<BusPositions, WMATAError> {
//        (self as NeedsRoute).positionsPublisher(on: route, at: location, key: key, session: session)
//    }
//
//    /// Bus incidents along a given route.
//    ///
